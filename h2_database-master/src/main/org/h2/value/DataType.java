...
public class DataType {
    ...
    static {
        ...
        // TO get memory required by PASSWORD.
        // TODO: Need to decide memory requirements.
        // TODO: string array elements need to finalise.
//        add(Value.PASSWORD, Types.VARCHAR, "String",
//                createString(true),
//                new String[]{"VARCHAR", "VARCHAR2", "NVARCHAR", "NVARCHAR2",
//                        "VARCHAR_CASESENSITIVE", "CHARACTER VARYING", "TID"},
//                // 24 for ValueString, 24 for String
...
//                case Value.PASSWORD: {
//                    //TODO: Need to add encryption validations.
//                    String s = rs.getString(columnIndex);
//                    v = (s == null) ? (Value) ValueNull.INSTANCE :
//                            ValueString.get(s);
//                    break;
    ...
    public static int convertSQLTypeToValueType(int sqlType) {
        switch (sqlType) {
            ...
            case Types.LONGNVARCHAR:
                // No need to add here. As these are Java types. We cannot modify those.
                return Value.STRING;
            case Types.NUMERIC:
            case Types.DECIMAL:
