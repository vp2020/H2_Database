            ...
            switch (targetType) {
                ...
                case INT: {
                    switch (getType()) {
                        ...
                        // Password cannot have only integer values.
                        case PASSWORD:
                        case TIMESTAMP_TZ:
                            throw DbException.get(
                                    ErrorCode.DATA_CONVERSION_ERROR_1, getString());
                ...
                case LONG: {
                    switch (getType()) {
                        ...
                        // Password cannot have only long values.
                        case PASSWORD:
                        case TIMESTAMP_TZ:
                            throw DbException.get(
                                    ErrorCode.DATA_CONVERSION_ERROR_1, getString());
                ...
                case DECIMAL: {
                    switch (getType()) {
                        ...
                        // Password cannot have only Decimal values.
                        case PASSWORD:
                        case TIMESTAMP_TZ:
                            throw DbException.get(
                                    ErrorCode.DATA_CONVERSION_ERROR_1, getString());
                ...
                case DOUBLE: {
                    switch (getType()) {
                        ...
                        case ENUM:
                            // Password cannot have only Double values.
                        case PASSWORD:
                        case TIMESTAMP_TZ:
                            throw DbException.get(
                                    ErrorCode.DATA_CONVERSION_ERROR_1, getString());
                ...
                case FLOAT: {
                    switch (getType()) {
                        ...
                        case ENUM:
                            // Password cannot have only Float values.
                        case PASSWORD:
                        case TIMESTAMP_TZ:
                            throw DbException.get(
                                    ErrorCode.DATA_CONVERSION_ERROR_1, getString());
                ...
                case DATE: {
                    switch (getType()) {
                        ...
                        // Password cannot have Date values.
                        case PASSWORD:
                ...
                case TIME: {
                    switch (getType()) {
                        ...
                        case ENUM:
                            // Password cannot have Time values.
                        case PASSWORD:
                            throw DbException.get(
                                    ErrorCode.DATA_CONVERSION_ERROR_1, getString());
                    }
                    ...
                    switch (getType()) {
                        ...
                        case TIMESTAMP_TZ:
                            return ValueTimestamp.fromDateValueAndNanos(
                                    ...
                                    ((ValueTimestampTimeZone) this).getTimeNanos());
                        case ENUM:
                            // Password cannot have only TIMESTAMP values.
                        case PASSWORD:
                ...
                case BYTES: {
                    switch (getType()) {
                        ...
                        case ENUM:
                            // Password cannot have bytes values.
                        case PASSWORD:
                ...
                case JAVA_OBJECT: {
                    switch (getType()) {
                        ...
                        case ENUM:
                            // TODO: Password cannot have only Float values.
                        case PASSWORD:
                        case TIMESTAMP_TZ:
                            throw DbException.get(
                                    ErrorCode.DATA_CONVERSION_ERROR_1, getString());
                ...
                case ENUM: {
                    switch (getType()) {
                        ...
                        // Password cannot have ENUM values.
                        case PASSWORD:
                ...
                case BLOB: {
                    switch (getType()) {
                        ...
                        // Password cannot have BLOB values.
                        case PASSWORD:
                ...
                case GEOMETRY: {
                    switch (getType()) {
                        ...
                        case TIMESTAMP_TZ:
                            // Password cannot have GEOMETRY values.
                        case PASSWORD:
...
//                        // TODO:
//                        case STRING:
//                            //TODO: Return value of password.
//                            return ValuePassword.get(new Password(getString()));
//                        case STRING_FIXED:
//                            // TODO: Return value of password.
//                            return ValuePassword.get(new Password(getString()));
//                        case STRING_IGNORECASE:
...
//                case PASSWORD:
//                    // TODO: Validate string with password validation criteria.
//                    return ValuePassword.get(new Password(s));
                default:
                    if (JdbcUtils.customDataTypesHandler != null) {
